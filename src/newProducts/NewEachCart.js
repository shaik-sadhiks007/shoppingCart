...
function NewEachCart({ eachItem }) {

    let { removeFromCart, quantChangePlus, quantChangeMinus } = useContext(productsContext);
    ...
    return (
        <div className="row">
            ...
            <div className="col-lg-5 col-6 d-flex flex-column">
            ...
            <div className="col-lg-2 col-md-3 col-6 d-flex flex-column align-items-lg-end align-items-md-center justify-content-center">
